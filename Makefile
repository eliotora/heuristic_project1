program : src/pfspinstance.h src/flowshop.cpp src/pfspinstance.cpp
	...
	g++ -O3 -c ./src/ILS.cpp -o src/ILS.o
	g++ -O3 -c ./src/MA.cpp -o src/MA.o
	g++ -O3 -c ./src/flowshopinstance.cpp -o src/flowshopinstance.o


	g++ -O3 src/flowshop.o src/ILS.o src/MA.o src/pfspinstance.o src/flowshopinstance.o src/utils.o -o pfspwt
